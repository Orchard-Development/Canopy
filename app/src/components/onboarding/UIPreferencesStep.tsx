...
import { MOOD_PRESETS, type MoodPreset } from "./presets/index";
...
export function UIPreferencesStep({ onComplete, onBack, setState }: StepProps) {
  ...
  function handlePresetSelect(preset: MoodPreset) {
    ...
    setError(null);
    setState({ branding: preset.config });
  }
