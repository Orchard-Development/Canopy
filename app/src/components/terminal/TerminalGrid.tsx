...
export function TerminalGrid({ tabs, profiles, columns, freeform, initialSpans, onSpansChange, onReorder, onCardFocus, onKill, onExit, scrollToId, onViewLog, onOpenLogFile, onAiSync }: Props) {
