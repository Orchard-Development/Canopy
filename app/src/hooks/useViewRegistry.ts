...
const DEFAULT_VIEWS: ViewEntry[] = [
  ...
  },
  {
    ...
    label: "Board",
    icon: "ViewKanban",
    component: COMPONENT_MAP["bundled:KanbanBoard"],
    source: "builtin",
    sourceId: null,
    position: 3,
    removable: false,
  ...
  },
  {
    ...
    label: "Files",
    icon: "FolderOpen",
    component: COMPONENT_MAP["bundled:FileBrowser"],
    source: "bundled",
    sourceId: null,
    position: 35,
    removable: true,
  ...
  },
  {
    ...
    label: "Interfaces",
    icon: "Devices",
    component: COMPONENT_MAP["bundled:Interfaces"],
    source: "default",
    sourceId: null,
    position: 60,
    removable: true,
  ...
  },
  {
    ...
    label: "Capabilities",
    icon: "Extension",
    component: COMPONENT_MAP["bundled:Capabilities"],
    source: "default",
    sourceId: null,
    position: 65,
    removable: true,
  ...
  {
    id: "default-application-viewer",
    path: "/applications",
    label: "Applications",
    icon: "Widgets",
    component: COMPONENT_MAP["bundled:ApplicationViewer"],
    source: "default",
    sourceId: null,
    position: 70,
    removable: true,
  ...
  {
    id: "default-autoresearch",
    path: "/autoresearch",
    label: "Autoresearch",
    icon: "Science",
    component: COMPONENT_MAP["bundled:Autoresearch"],
    source: "default",
    sourceId: null,
    position: 75,
    removable: true,
  ...
  },
  {
    ...
    label: "Judgment",
    icon: "Psychology",
    component: COMPONENT_MAP["bundled:Judgment"],
    source: "default",
    sourceId: null,
    position: 77,
    removable: true,
  ...
  },
  {
    ...
    label: "Swarm",
    icon: "BugReport",
    component: COMPONENT_MAP["bundled:Swarm"],
    source: "default",
    sourceId: null,
    position: 78,
    removable: true,
  ...
  {
    id: "default-scheduled-tasks",
    path: "/scheduled-tasks",
    label: "Scheduled Tasks",
    icon: "Schedule",
    component: COMPONENT_MAP["bundled:ScheduledTasks"],
    source: "default",
    sourceId: null,
    position: 79,
    removable: true,
  ...
  {
    id: "default-database-explorer",
    path: "/database",
    label: "Database",
    icon: "Storage",
    component: COMPONENT_MAP["bundled:DatabaseExplorer"],
    source: "default",
    sourceId: null,
    position: 80,
    removable: true,
